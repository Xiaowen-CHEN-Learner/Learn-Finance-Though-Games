...
(function () {
    const pokerData = [
        ...
        { difficulty: 'Intermediate', visual: 'A♠ A♥ vs K♠ K♥ — preflop', q: "Pre-flop. You hold AA. Opponent holds KK. Win rate for Aces?", opts: ["~65%", "~81%", "~95%"], correct: 1, explain: "~82% (82.4% exact for these suits; 81.1%–82.4% across suit combinations). Aces dominate Kings pre-flop: KK mostly needs one of the two remaining Kings, or a straight or flush, to win, making AA an overwhelming favorite." },
